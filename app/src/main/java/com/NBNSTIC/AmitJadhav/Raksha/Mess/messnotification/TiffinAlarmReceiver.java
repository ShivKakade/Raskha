package com.NBNSTIC.AmitJadhav.Raksha.Mess.messnotification;
...
import com.NBNSTIC.AmitJadhav.Raksha.Account.SplashActivity;
...
public class TiffinAlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        builder.setSmallIcon(R.mipmap.sinhgad);
        builder.setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.mipmap.sinhgad));
