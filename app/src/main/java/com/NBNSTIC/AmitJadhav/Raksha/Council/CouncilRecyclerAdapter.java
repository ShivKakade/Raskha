...
public class CouncilRecyclerAdapter extends RecyclerView.Adapter<CouncilRecyclerAdapter.ItemViewHolder> {
    ...
    private final ArrayList<String> councilName;
    private final ArrayList<Integer> councilImage;
    ...
    public static class ItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private final TextView councilTextView;
        private final ImageView councilImageView;
